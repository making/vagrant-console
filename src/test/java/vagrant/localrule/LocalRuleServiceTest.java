...
public class LocalRuleServiceTest {

    @Test
    public void testList() throws Exception {
        ListVmsCommand listVmsCommand = new ListVmsCommand(() -> Arrays.asList(("Name:            apsrv01_default_1393153752357_51723\n" +
                "Groups:          /\n" +
        ...
        new LocalRuleService(listVmsCommand, globalStatusCommand)
                .list()
                .stream()
